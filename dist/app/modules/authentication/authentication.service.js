...
const registerUser = ({ requestBody }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userWithTheSameEmail) {
        throw new error_1.UnprocessableEntity(errorDetailsConstants_1.default.DUPLICATE_EMAILS);
    }
...
const resendConfirmationEmail = ({ requestBody }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!updatedUser) {
        throw new error_1.NotFound(errorDetailsConstants_1.default.USER_NOT_FOUND_OR_ACCOUNT_CONFIRMED);
    }
...
const confirmAccount = ({ requestParams }) => __awaiter(void 0, void 0, void 0, function* () {
...
const logIn = ({ requestBody }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    yield (0, authentication_check_1.checkIfPasswordsMatch)(user === null || user === void 0 ? void 0 : user.password, requestBody.password);
    (0, authentication_check_1.checkIfUserAccountIsNotConfirmed)(user === null || user === void 0 ? void 0 : user.confirmationLevel);
    const sessionToken = (0, jwt_1.createToken)(user);
    const userWithToken = Object.assign(Object.assign({}, user === null || user === void 0 ? void 0 : user.toJSON()), { token: sessionToken });
    delete userWithToken.password;
    (_a = userWithToken.twoFactorAuth) === null || _a === void 0 ? true : delete _a.secret;
    return userWithToken;
});
exports.logIn = logIn;
const requestNewPassword = ({ requestBody }) => __awaiter(void 0, void 0, void 0, function* () {
...
const resetPassword = ({ requestBody }) => __awaiter(void 0, void 0, void 0, function* () {
...
const initTwoFactorAuthentication = ({ userId }) => __awaiter(void 0, void 0, void 0, function* () {
...
const completeTwoFactorAuthentication = ({ userId, requestBody, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const verifyTwoFactorAuthToken = ({ userId, requestParams, }) => __awaiter(void 0, void 0, void 0, function* () {
