...
const getAllTickets = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tickets = yield service.getAllTickets({
...
const addNewTicket = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const ticket = req.body;
        const result = yield service.addNewTicket(ticket);
