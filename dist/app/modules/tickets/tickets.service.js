...
const dal = __importStar(require("./tickets.dal"));
const validator = __importStar(require("./tickets.validator"));
const errorDetailsConstants_1 = __importDefault(require("../../constants/errorDetailsConstants"));
const getAllTickets = ({ requestParams }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ticket = yield dal.getAllTickets(query, projection);
    return ticket;
});
exports.getAllTickets = getAllTickets;
const addNewTicket = (ticket) => __awaiter(void 0, void 0, void 0, function* () {
    validator.validateTicket(ticket);
    const newTicket = yield dal.addNewTicket(ticket);
    return newTicket;
});
exports.addNewTicket = addNewTicket;
const deleteTicketById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const ticket = yield dal.deleteTicket(id);
    if (!ticket) {
        throw new error_1.NotFound(errorDetailsConstants_1.default.TICKET_NOT_FOUND);
    }
});
